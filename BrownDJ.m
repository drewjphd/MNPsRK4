...
function [M,t]=BrownDJ(Bv,Bs,freq,T,visc,N,cycs,tPts,rhm,rco)
...
if nargin<9;  rhm = 60e-9; end %    %hydrodynamic radius [m] (defaults give tE=1.04ms)
...
Vhm = 4/3*pi*rhm^3; %NP hmdrodmnamic volume [m^3]
