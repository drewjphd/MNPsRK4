...
for t=0:dt:tf
    ...
    k1 = h(t, m, Du, b, Dv, Bs, f) * dt + g(m, Dv, N) .* dW;
    k2 = h(t + 0.5 * dt, m + 0.5 * k1, Du, b, Dv, Bs, f) * dt + g(m + 0.5 * k1, Dv, N) .* dW;
    k3 = h(t + 0.5 * dt, m + 0.5 * k2, Du, b, Dv, Bs, f)  * dt +  g(m + 0.5 * k2, Dv, N) .* dW;
    k4 = h(t + dt, m + k3, Du, b, Dv, Bs, f) * dt + g(m + k3, Dv, N) .* dW;
